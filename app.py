...
def send_crisis_alert_email(user_id: str, message: str):
    """Send a plain-text, well-written crisis alert email to the Mindly team."""
    try:
        ...
        subject = "Mindly Crisis Alert - Immediate Review Recommended"

        body = f"""Mindly has detected a message that may indicate a user is in crisis.

User Information -
User ID: {user_id or 'Unknown'}
Name: {display_name or 'friend'}
Email: {user_email or 'Not found'}
...
Please review this user’s session in Firestore and follow up as soon as possible. If appropriate, you may contact the user directly at {user_email or 'friend'} to ensure they receive timely support.

This alert was automatically generated by the Mindly safety system.
"""
        ...
        print(f"[CRISIS ALERT] Email sent successfully to {recipient_email} for user {user_email or user_id}")
